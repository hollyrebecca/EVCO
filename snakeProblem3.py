...
pset.addTerminal(sna# This code defines the agent (as in the playable version) in a way that can be called and 
# executed from an evolutionary algorithm. The code is partial and will not execute. You need to 
# add to the code to create an evolutionary algorithm that evolves and executes a snake agent.
import curses
import random
...
ke.changeDirectionRight, name="changeDirectionRight")
pset.addTerminal(snake.changeDirectionLeft, name="changeDirectionLeft")
pset.addTerminal(snake.stayStraight, name="stayStraight")
#pset.addTerminal(snake.changeDirectionUp)
#pset.addTerminal(snake.changeDirectionDown)
